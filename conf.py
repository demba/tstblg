...
BLOG_TITLE = "Testing Nikola Workflow"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://mssngwnkl.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://mssngwnkl.com/"
BLOG_EMAIL = "dembayel@gmail.com"
BLOG_DESCRIPTION = "This is a site where I play with Nikola commands and config"  # (translatable)
